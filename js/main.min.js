(function() {
    ...
    function charactersModal(count) {
        var currentChar, charBtn = $(".char_btn"), details = $("#char-details"), charContainers = $(".tap-info");
        ...
        function detailsGenerator(count) {
            var currId = charContainers[count].id, overallCharContainer = $("#modal-char"), charIntro = $(".tap-banner-" + currId).html(), charBrief = $("#" + currId).html();
    ...
    function galleryModal(count) {
        var gallery = $("#modal-gallery"), galleryItems = $(".gallery-imgs").find("li"), picturePath;
    ...
    var gallerySwipe = function() {
        var initNumber = 1, itemSwipe = $(".slider-content"), contentSwipe = $("#gallery-container");
        contentSwipe.swipe({
            swipeLeft: function() {
    ...
    function navCreditos() {
        var openCreditsMenu = $(".show-menu").find(".display"), content = $(".team-nav-content"), arrow = $("#show-menu-arrow");
    ...
    function videoTeaserModal() {
        var video = $(".teaser"), close = $(".teaser .close"), btn = $("#btn-play-js"), player = $("#ytplayer"), content = '<iframe src="https://player.vimeo.com/video/146402139?autoplay=1&color=24C29F&title=0&byline=0&portrait=0" frameborder="0"></iframe>';
        btn.click(function() {
            player.html(content);
