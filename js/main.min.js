(function() {
    ...
    function videoTeaserModal() {
        var video = $("#main-video"), btn = $("#btn-play-js"), close = $("#close"), player = $("#ytplayer"), content = '<iframe class="main-video-player" width="640" height="480" src="https://www.youtube.com/embed/E7CaTJ2SvG8' + "?autoplay=1&amp;rel=0&amp;" + 'controls=1&amp;showinfo=1"  frameborder="0"/>';
        btn.click(function() {
