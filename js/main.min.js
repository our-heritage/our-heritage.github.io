(function() {
    ...
    function navCreditos() {
        var openCreditsMenu = $(".show-menu, .display"), content = $(".team-nav-content"), arrow = $("#show-menu-arrow");
    ...
    function videoTeaserModal() {
        var video = $(".teaser"), close = $(".teaser .close"), btn = $("#btn-play-js"), player = $("#ytplayer"), content = '<iframe src="https://www.youtube.com/embed/BeLZicohxl4' + "?autoplay=1&amp;rel=0&amp;" + 'controls=1&amp;showinfo=1"  frameborder="0"></iframe>';
        btn.click(function() {
            player.html(content);
