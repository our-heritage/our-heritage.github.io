(function() {
    ...
    function tapCharacter() {
        var closeTap = $(".close-tap"), tapCharacter = $(".taps-character div");
    ...
    function videoTeaserModal() {
        var video = $(".teaser"), close = $(".teaser .close"), btn = $("#btn-play-js"), player = $("#ytplayer"), content = '<iframe class="main-video-player" width="640" height="480" src="https://www.youtube.com/embed/DLzxrzFCyOs' + "?autoplay=1&amp;rel=0&amp;" + 'controls=1&amp;showinfo=1"  frameborder="0"/>';
        btn.click(function() {
