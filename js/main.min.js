(function() {
    $(document).ready(function() {
        var count = 0, test = "Jose";
        enquire.register("screen and (min-width: 768px) and (max-width: 1280px)", function() {
            navGameScroll();
    ...
    function charactersModal(count) {
        var currentChar, charBtn = $(".char_btn"), overallCharContainer = $("#char_details"), details = $("#details"), charContainers = $(".tap-info");
        ...
        function detailsGenerator(count) {
            var currId = charContainers[count].id, charIntro = $(".tap-banner-" + currId).html(), charBrief = $("#" + currId).html();
    ...
    function gallerySwipe(count) {
        var initNumber = 1, counterNumber, itemSwipe = $(".slider-content"), counterSwipe = $("#counter-slider"), contentSwipe = $("#gallery-container"), countIteam = itemSwipe.length - 1;
        contentSwipe.swipe({
    ...
    function menuLang() {
        var closeNavLang = $(".close-lang"), listLang = $("#list-lang"), listLangItem = $(".list-lang-item");
    ...
    function tapCharacter() {
        var closeTap = $(".close-tap"), tapCharacter = $(".taps-character .tap-banner");
    ...
    function videoTeaserModal() {
        var video = $(".teaser"), btn = $("#btn-play-js"), close = $("#close"), player = $("#ytplayer"), content = '<iframe class="main-video-player" width="640" height="480" src="https://www.youtube.com/embed/DLzxrzFCyOs' + "?autoplay=1&amp;rel=0&amp;" + 'controls=1&amp;showinfo=1"  frameborder="0"/>';
        btn.click(function() {
